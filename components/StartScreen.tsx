  ...
  return (
    <div className="flex flex-col items-center gap-6 animate-fade-in w-full max-w-5xl mx-auto text-center p-4 sm:p-8">
      <h1 className="text-5xl font-extrabold tracking-tight text-gray-100 sm:text-6xl md:text-7xl">
        Haotian AI <span className="text-blue-400">智能改图</span>
      </h1>
      <div className="max-w-2xl text-lg text-gray-400 md:text-xl flex flex-col gap-2">
        <h3 className="text-3xl font-extrabold tracking-tight text-gray-100 sm:text-4xl md:text-5xl">化繁为简&专业级体验</h3>
        <p className="font-semibold text-yellow-300">智能驱动，随心所欲改图，专为创作与效率而生</p>
      </div>
      ...
      <div className="w-full max-w-4xl mt-8 grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
        ...
        >
          <div className="flex flex-col items-center gap-4 text-center">
            <h2 className="text-2xl font-bold text-gray-100 text-center">用 AI <span className="text-purple-400">编辑图像</span></h2>
