    ...
    return (
        <div className="w-full flex flex-col items-center justify-center text-center p-4 min-h-[80vh] font-['Roboto'] relative overflow-hidden">
            ...
            {(appState === 'idle' || appState === 'image-uploaded') && (
                ...
                >
                    <h1 className="font-['Caveat'] text-7xl md:text-9xl font-bold text-white tracking-wider">时光穿梭</h1>
                    <p className="text-gray-300 text-lg md:text-2xl -mt-4">用一张照片，走遍过去与未来</p>
                    ...
                    >
                        {uploadedImage ? (
                            ...
                            <div className="text-center text-gray-700">
                                ...
                                <p className="font-bold mt-2 font-['Permanent_Marker']">点击上传照片</p>
                            </div>
                        )}
                    </div>
            ...
            {(appState === 'generating' || appState === 'results-shown') && (
                ...
                >
                    <h2 className="font-['Caveat'] text-5xl md:text-6xl font-bold text-white tracking-wider my-4">你的时光穿梭</h2>
                    ...
                    <div className="relative z-10 mt-8 flex flex-col md:flex-row items-center gap-4">
                        <button onClick={resetState} className="text-gray-300 hover:text-white underline">
                            重新开始
                        </button>
